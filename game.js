...
const levelConfigs = [
  ...
  },
  {
    ...
    obstacles: [
      ...
      { kind: "destructible", breakSpeed: 8.8, x: 0.7, y: 0.7, width: 0.14, height: 18 },
  ...
  {
    targetSpeed: 12.0,
    goal: { edge: "bottom", align: 0.68, length: 0.5, thickness: 1.38 },
    obstacles: [
      { kind: "destructible", breakSpeed: 10.4, x: 0.34, y: 0.44, width: 18, height: 0.18 },
      { kind: "solid", x: 0.48, y: 0.58, width: 0.15, height: 18 },
      { kind: "destructible", breakSpeed: 9.0, x: 0.58, y: 0.7, width: 18, height: 0.16 },
      { kind: "solid", x: 0.76, y: 0.56, width: 0.13, height: 18 },
      { kind: "destructible", breakSpeed: 11.7, x: 0.78, y: 0.78, width: 0.12, height: 18 },
      { kind: "destructible", breakSpeed: 11.5, x: 0.46, y: 0.84, width: 18, height: 0.13 },
      { kind: "solid", x: 0.68, y: 0.985, width: 0.28, height: 0.025 }
    ]
  },
  {
    targetSpeed: 12.0,
    ...
    obstacles: [
      ...
      { kind: "destructible", breakSpeed: 9.4, x: 0.68, y: 0.34, width: 0.13, height: 18 },
  ...
  {
    targetSpeed: 12.0,
    goal: { edge: "top", align: 0.42, length: 0.46, thickness: 1.45 },
    obstacles: [
      { kind: "destructible", breakSpeed: 8.6, x: 0.28, y: 0.3, width: 0.12, height: 18 },
      { kind: "solid", x: 0.44, y: 0.42, width: 18, height: 0.24 },
      { kind: "destructible", breakSpeed: 11.4, x: 0.58, y: 0.28, width: 0.12, height: 18 },
      { kind: "solid", x: 0.7, y: 0.54, width: 0.14, height: 18 },
      { kind: "destructible", breakSpeed: 11.8, x: 0.5, y: 0.68, width: 0.24, height: 18 },
      { kind: "destructible", breakSpeed: 12.0, x: 0.34, y: 0.58, width: 0.1, height: 18 },
      { kind: "destructible", breakSpeed: 11.2, x: 0.72, y: 0.34, width: 18, height: 0.14 },
      { kind: "solid", x: 0.82, y: 0.76, width: 18, height: 0.18 },
      { kind: "solid", x: 0.3, y: 0.18, width: 0.22, height: 0.09 },
      { kind: "solid", x: 0.62, y: 0.18, width: 0.28, height: 0.09 }
    ]
  },
  {
    targetSpeed: 12.0,
    goal: { edge: "bottom", align: 0.66, length: 0.66, thickness: 1.5 },
    obstacles: [
      { kind: "solid", x: 0.28, y: 0.34, width: 18, height: 0.2 },
      { kind: "destructible", breakSpeed: 10.9, x: 0.36, y: 0.28, width: 0.13, height: 18 },
      { kind: "destructible", breakSpeed: 11.6, x: 0.46, y: 0.5, width: 18, height: 0.16 },
      { kind: "solid", x: 0.48, y: 0.66, width: 0.13, height: 18 },
      { kind: "destructible", breakSpeed: 11.9, x: 0.62, y: 0.58, width: 0.2, height: 18 },
      { kind: "solid", x: 0.76, y: 0.46, width: 0.13, height: 18 },
      { kind: "destructible", breakSpeed: 11.3, x: 0.72, y: 0.74, width: 18, height: 0.14 },
      { kind: "destructible", breakSpeed: 12.0, x: 0.36, y: 0.8, width: 0.18, height: 18 },
      { kind: "solid", x: 0.34, y: 0.86, width: 0.28, height: 0.09 },
      { kind: "solid", x: 0.82, y: 0.86, width: 0.24, height: 0.09 }
    ]
  },
  {
    targetSpeed: 12.0,
    ...
    obstacles: [
      { kind: "destructible", breakSpeed: 8.8, x: 0.18, y: 0.25, width: 0.22, height: 0.18 },
      { kind: "solid", x: 0.38, y: 0.42, width: 0.14, height: 18 },
      { kind: "destructible", breakSpeed: 9.6, x: 0.51, y: 0.56, width: 0.1, height: 0.17 },
      { kind: "solid", x: 0.64, y: 0.28, width: 0.13, height: 18 },
      { kind: "destructible", breakSpeed: 11.8, x: 0.745, y: 0.46, width: 0.07, height: 18 },
      { kind: "destructible", breakSpeed: 11.2, x: 0.745, y: 0.72, width: 0.07, height: 0.16 },
      { kind: "destructible", breakSpeed: 9.2, x: 0.51, y: 0.82, width: 0.1, height: 0.15 },
      { kind: "destructible", breakSpeed: 12.0, x: 0.745, y: 0.52, width: 0.07, height: 0.13 },
  ...
  },
  {
    ...
    obstacles: [
      ...
      { kind: "destructible", breakSpeed: 8.4, x: 0.36, y: 0.46, width: 18, height: 0.16 },
